...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="/templates/default/icon.png" />
          <!-- Vendor CSS Files -->
  <link href="/templates/default/assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <link href="/templates/default/assets/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet">
  <link href="/templates/default/assets/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
  <link href="/templates/default/assets/vendor/quill/quill.snow.css" rel="stylesheet">
  <link href="/templates/default/assets/vendor/quill/quill.bubble.css" rel="stylesheet">
  <link href="/templates/default/assets/vendor/remixicon/remixicon.css" rel="stylesheet">
  <link href="/templates/default/assets/vendor/simple-datatables/style.css" rel="stylesheet">
...
markers.forEach(item => {
    if(item.date == date_filter.value) {
        ...
        marker.bindPopup("<img width='200px'; height='200px'; src='/templates/default/" + item.type + ".jpg'><br>" + "<div style='font-size: 18px;'>" + item.note + "</div>").openPopup()
            ...
            if(activ_box.checked) {
                ...
                for (let i = 0; i < markers.length; i++) {
                    if(markers[i].type == activ_box.id && markers[i].date == date_filter.value) {
                        ...
                        marker.bindPopup("<img width='200px'; height='200px'; src='/templates/default/" + markers[i].type + ".jpg'><br>" + "<div style='font-size: 18px;'>" + markers[i].note + "</div>").openPopup()
                        map.addLayer(marker)
                        markers_array.push(marker)
                    }
                }   
...
<script src="/templates/default/assets/vendor/apexcharts/apexcharts.min.js"></script>
<script src="/templates/default/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
<script src="/templates/default/assets/vendor/chart.js/chart.umd.js"></script>
<script src="/templates/default/assets/vendor/echarts/echarts.min.js"></script>
<script src="/templates/default/assets/vendor/quill/quill.min.js"></script>
<script src="/templates/default/assets/vendor/simple-datatables/simple-datatables.js"></script>
<script src="/templates/default/assets/vendor/tinymce/tinymce.min.js"></script>
<script src="/templates/default/assets/vendor/php-email-form/validate.js"></script>
