...
abstract class BaseModel extends BaseModelMethods
{
    ...
    protected function connect()
    {
        ...
        $this->db->query("CREATE TABLE IF NOT EXISTS `upload_video` (`id` int NOT NULL AUTO_INCREMENT,`video` varchar(255) NOT NULL,`name` varchar(255) NOT NULL,`description` text NOT NULL,`date_create` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,`quality` int NOT NULL,`commentary` int NOT NULL,`is_processed` int NOT NULL, PRIMARY KEY (id))");
